...
import { useState, useCallback, memo, useMemo, useRef, useEffect, lazy, Suspense } from 'react';
...
const AdvancedTab = lazy(() => import('./stats/AdvancedTab').then(m => ({ default: m.AdvancedTab })));
import {
  StatRow,
  SectionTitle,
  DataListRow,
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {activeTab === 'advanced' && (
              <Suspense fallback={<p style={{ color: '#94a3b8' }}>분석 로딩 중...</p>}>
                <AdvancedTab detailed={detailed} />
              </Suspense>
            )}
