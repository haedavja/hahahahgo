...
const PATCH_VERSION_TAG = "11-16-14:40"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-14:40 갱신 내역
 * - 손패 인터페이스 레이아웃 재구성:
 *   - 왼쪽: 에너지 구체만 배치
 *   - 중앙: 조합 디스플레이 + 그 밑에 속도/선택 텍스트 및 리드로우 버튼
 *   - 오른쪽: 제출/진행 버튼만 배치
 * - 손패 인터페이스 배경 완전 투명화: background transparent, backdrop-filter none
 * - 리드로우 버튼을 속도/선택 텍스트 옆으로 이동
 */
