...
const PATCH_VERSION_TAG = "11-15-23:50"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-15-23:50 갱신 내역
 * - 에테르 바 pt 텍스트 실시간 업데이트 디버깅 (key prop 추가)
 * - 조합 감지 로직 디버깅 로그 추가 (플러시/투페어 오감지 추적)
 * - 콘솔 로그로 에테르 값 및 조합 감지 상태 확인 가능
 */
