...
const PATCH_VERSION_TAG = "11-16-13:40"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-13:40 갱신 내역
 * - 손패 인터페이스 대폭 개선: 예시 13 기반으로 재설계
 * - "손패" 텍스트 왼쪽 끝 배치 및 크기 확대 (1.5rem)
 * - 에너지 오브 제거, 텍스트 기반으로 단순화
 * - "남은 에너지", "속도", "선택" 텍스트 크기 확대 및 가독성 향상
 * - 모든 정보를 한 줄에 배치하여 컴팩트한 UI 구현
 */
