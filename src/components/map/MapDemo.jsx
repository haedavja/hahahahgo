...
const PATCH_VERSION_TAG = "11-16-09:19"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-09:19 갱신 내역
 * - 제출된 카드 단계 영역 삭제 (진행/대응 단계 submitted-cards-area)
 * - 손패 영역으로 모든 인터페이스 통합 (모든 단계에서 손패 유지)
 * - 플레이어 에테르바를 맨 왼쪽으로 이동
 */
