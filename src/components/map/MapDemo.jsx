...
const PATCH_VERSION_TAG = "11-16-13:37"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-13:37 갱신 내역
 * - 선택 단계 카드 정보 표시 수정: damage, block, speedCost 값이 명확히 표시되도록 조건 개선
 * - 카드 스탯 색상 inline style로 변경: 더 명확한 색상 표시
 */
