...
const PATCH_VERSION_TAG = "11-16-13:35"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-13:35 갱신 내역
 * - 예상 피해량 라벨 변경: "예상 타격 피해", "예상 피격 피해"로 명칭 개선
 * - 예상 피해 로그 위치 이동: HP 정보 밑으로 한 칸 띄워서 배치
 * - 적 카드 공개 로그 제거: 대응 단계 로그에서 "🤖 적 카드 공개" 메시지 삭제
 * - 에테르 획득 타이밍 변경: 진행 단계 시작 시점에서 에테르 획득하도록 수정
 */
