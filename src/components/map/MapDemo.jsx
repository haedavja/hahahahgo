...
const PATCH_VERSION_TAG = "11-16-13:57"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-13:57 갱신 내역
 * - 손패 인터페이스 높이 15% 축소: 텍스트 크기 및 gap 조정으로 컴팩트화
 * - 예상 피해량 로그 색상 개선: 플레이어/몬스터의 모든 행동(공격+방어) 색상 구분
 * - 플레이어 방어 카드도 파란색으로 표시
 * - 몬스터 방어 카드도 옅은 붉은색으로 표시
 */
