...
const PATCH_VERSION_TAG = "11-16-09:02"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-09:02 갱신 내역
 * - 몬스터 에테르바를 붉은색(red)으로 변경
 * - 플레이어 손패를 화면 하단에 고정 (스크롤 무관)
 * - 타임라인 레이아웃을 세로에서 가로로 변경 (속도 축이 가로로)
 */
