...
const PATCH_VERSION_TAG = "11-16-08:54"; // 다음 패치마다 여기를 최신 시간(월-일-시:분, KST)으로 갱신하세요.

/* v11-16-08:54 갱신 내역
 * - 몬스터 라벨 삭제, 에테르 바를 오른쪽 끝으로 이동
 * - 플레이어 캐릭터 아이콘을 에테르 바 오른쪽으로 이동
 * - "에테르 폭주" 버튼을 "기도"로 변경
 * - 선택 단계에서 플레이어 피격 피해를 "?"로 표시
 * - 인터페이스 압축 (padding, gap, font-size 축소)
 */
