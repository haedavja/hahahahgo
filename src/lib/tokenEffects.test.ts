...
describe('tokenEffects', () => {
  ...
  describe('applyTokenEffectsToCard', () => {
    it('null 카드는 그대로 반환해야 함', () => {
      ...
      const result = applyTokenEffectsToCard(null, entity, 'attack');
    ...
    it('null 엔티티는 원본 카드를 반환해야 함', () => {
      ...
      const result = applyTokenEffectsToCard(card, null, 'attack');
    ...
    it('사용소모 토큰은 소모 목록에 추가되어야 함', () => {
      ...
      expect(result.consumedTokens).toContainEqual({ id: 'offense', type: 'usage' });
    });
  });

  describe('applyTokenEffectsOnDamage', () => {
    it('null defender는 원본 피해를 반환해야 함', () => {
      const result = applyTokenEffectsOnDamage(10, null, {});
    ...
    it('회피 토큰이 성공하면 피해가 0이어야 함', () => {
      ...
      const result = applyTokenEffectsOnDamage(10, defender, {});
  ...
  describe('applyTokenEffectsOnHeal', () => {
    it('null 엔티티는 회복 0을 반환해야 함', () => {
      const result = applyTokenEffectsOnHeal(10, null);
  ...
  describe('applyTokenEffectsOnEnergy', () => {
    it('null 엔티티는 기본 에너지를 반환해야 함', () => {
      const result = applyTokenEffectsOnEnergy(5, null);
  ...
  describe('getTotalStrength', () => {
    it('null 엔티티는 0을 반환해야 함', () => {
      expect(getTotalStrength(null)).toBe(0);
    });
  ...
  describe('getTotalAgility', () => {
    it('null 엔티티는 0을 반환해야 함', () => {
      expect(getTotalAgility(null)).toBe(0);
    });
  ...
  describe('checkReviveToken', () => {
    it('null 엔티티는 부활 불가를 반환해야 함', () => {
      const result = checkReviveToken(null);
    ...
    it('부활 토큰이 있으면 부활해야 함', () => {
      ...
      expect(result.consumedTokens).toContainEqual({ id: 'revive', type: 'usage' });
    });
  });
  ...
  describe('consumeTokens', () => {
    ...
    it('지정된 토큰을 소모해야 함', () => {
      ...
      const result = consumeTokens(entity, [{ id: 'offense', type: 'usage' }]);
